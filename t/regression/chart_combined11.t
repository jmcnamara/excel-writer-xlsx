...
$chart1->{_axis_ids}  = [ 108637184, 108644992 ];
# $chart1->{_axis2_ids} = [ 143247232, 119386112 ];
$chart2->{_axis2_ids} = [ 143247232, 119386112 ];
...
$chart1->add_series( values => '=Sheet1!$B$1:$B$5', y2_axis => 1);

$chart2->add_series( values => '=Sheet1!$C$1:$C$5', y2_axis => 1 );
