...
###############################################################################
#
# 4. Test _position_object() for image vertices.
#
$caption = " \tWorksheet: _position_object()";
...
@got = $worksheet->_position_object( 4, 8, 0, 0, 32, 32 );
...
###############################################################################
#
# 5. Test _position_object() for image vertices.
#
$caption = " \tWorksheet: _position_object()";
...
@got = $worksheet->_position_object( 4, 8, 2, 3, 72, 72 );
...
###############################################################################
#
# 6. Test _position_object() for image vertices.
#
$caption = " \tWorksheet: _position_object()";
...
@got = $worksheet->_position_object( 5, 1, 2, 3, 99, 69 );
